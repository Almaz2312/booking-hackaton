### booking-hackaton
 This is a project that is made for booking a conference. It has simple functions to view which conference are there via ListView and DetailView. There is also a filter function added to conference, which filters by four parameters - conference_type, projector, conditioner, board in ListView.  
